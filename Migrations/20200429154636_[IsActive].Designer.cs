...
namespace AWS.Cognito.Authorization.Authentication.MVP.Migrations
{
    ...
    [Migration("20200429154636_[IsActive]")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WEBCOPY1.Models.Building", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WEBCOPY1.Models.BuildingUser", b =>
                {
            ...
            modelBuilder.Entity("WEBCOPY1.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WEBCOPY1.Models.User", null)
                        .WithMany()
